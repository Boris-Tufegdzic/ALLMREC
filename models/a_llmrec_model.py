...
class A_llmrec_model(nn.Module):
    def __init__(self, args):
        ...
        # with open(f'../data/yelp/yelp_text_name_dict.json.gz','rb') as ft:
    ...
    def save_model(self, args, epoch1=None, epoch2=None):
        ...
        #     os.makedirs(out_dir)
        # #colab
        # out_dir = '/content/drive/MyDrive/saved_models/allmrec/' 
        # if not os.path.exists(out_dir):
        #     os.makedirs(out_dir)
    ...
    def load_model(self, args, phase1_epoch=None, phase2_epoch=None):
        #kaggle
        out_dir = f'/kaggle/input/phase1-1/yelp_allmrec_{phase1_epoch}/'
    ...
    def pre_train_phase2(self, data, optimizer, batch_iter):
        ...
        for i in range(len(u)):
            ...
            input_text += ' in the previous. Recommend one next place for this user to visit next from the following businesses title set, '
